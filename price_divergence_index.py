...
def calculate_bearish_divergence(data, macd_column, window, name="macd"):
    ...
    if name == "macd":
        ...
        cutoff = 35  # Adjusted for bearish divergence in RSI (typically below 30)
    elif name == "stoch":
        cutoff = 40  # Adjusted for bearish divergence in Stochastic (typically below 20)
...
def call_div_func(data):
    ...
    data = calculate_bullish_divergence(data, "MACD_12_26_9", 45, "macd")
    ...
    data = calculate_bearish_divergence(data, "MACD_12_26_9", 15, "macd")
    data = calculate_bearish_divergence(data, "MACD_12_26_9", 30, "macd")
    data = calculate_bearish_divergence(data, "MACD_12_26_9", 45, "macd")
