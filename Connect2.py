...
class XTSConnect(XTSCommon):
    ...
    def __init__(self,
        ...
        super().__init__(token=token, userID=userID, isInvestorClient=isInvestorClient)
    ...
    def interactive_login(self):
        ...
        try:
            ...
            if self.token:
                self._set_common_variables(self.token, self.userID,
                                           self.isInvestorClient)
